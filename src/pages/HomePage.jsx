        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            ...
            <h1 className="mb-4">
              ...
              <p className="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed eveniet iure animi delectus porro itaque</p>
      ...
      <div className="kelas w-100 min-vh-100">
        <Container>
          ...
          <Row>
            ...
            <button className="btn btn-succes rounded-5 btn-lg" onClick={() => navigate("/kelas")}>Lihat Semua Kelas <i className="fa-solid fa-chevron-right ms-1"></i>
            </button>
            </Col>
          </Row>
        </Container>
